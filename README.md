...
<table>
  <tr>
    <td width="50%" valign="top">
      <sub>01 / THE TOOL</sub>
      <h3>Grit</h3>
      <p>Task ledger in SQLite, memory vault in Markdown, hybrid search with local embeddings, hooks for every harness. Leases, fence tokens and evidence gates run in Python, so a model cannot talk its way past them.</p>
      <p><b>Source opens with the licence decision. Early access: write me on X.</b></p>
    </td>
    <td width="50%" valign="top">
      <sub>02 / SKILLS</sub>
      <h3>Grit Skills</h3>
      <p>The skills Grit ships to its workers: evidence-gated delivery, GPT Pro review handoff, design production, systematic debugging. Each keeps its upstream licence.</p>
      <p><b>Repository opening after the licence review.</b></p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
    ...
    <td width="50%" valign="top">
      <sub>04 / THE SITE</sub>
      <h3>grithub.dev</h3>
      <p>Try the ledger in the browser, no install, and watch an anonymised live status feed from the real ledger.</p>
...
- **"Done" is a claim.** The acceptance command is re-run inside the worktree; the evidence is its output. No record, no done.
